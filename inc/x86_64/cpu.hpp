...
class Cpu final
{
    ...
    public:
        ...
        struct State_sys
        {
             ...
             */
            void make_current (State_sys const &o) const
            {
                if (o.star != star) [[unlikely]]
                    Msr::write (Msr::Reg64::IA32_STAR, star);

                if (o.lstar != lstar) [[unlikely]]
                    Msr::write (Msr::Reg64::IA32_LSTAR, lstar);

                if (o.fmask != fmask) [[unlikely]]
                    Msr::write (Msr::Reg64::IA32_FMASK, fmask);

                if (o.kernel_gs_base != kernel_gs_base) [[unlikely]]
                    Msr::write (Msr::Reg64::IA32_KERNEL_GS_BASE, kernel_gs_base);
            }
        ...
        struct State_tsc
        {
             ...
             * @param o     Old live state
             */
            void make_current (State_tsc const &o) const
            {
                if (o.tsc_aux != tsc_aux) [[unlikely]]
                    Msr::write (Msr::Reg64::IA32_TSC_AUX, tsc_aux);
            }
            ...
            {
                return feature (Feature::RDPID) || feature (Feature::RDTSCP) ? v & BIT64_RANGE (31, 0) : 0;
            }
        };
        ...
        static uint32_t     upatch          CPULOCAL;
        static uint8_t      family          CPULOCAL;
        static uint8_t      model           CPULOCAL;
        static uint8_t      stepping        CPULOCAL;
        static uint8_t      platform        CPULOCAL;
        static uint8_t      type            CPULOCAL;
