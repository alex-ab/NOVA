...
class Invvpid final
{
    ...
    public:
        ...
        Invvpid (uint16_t v, uint64_t a) : vpid { v }, addr { a } {}
};
...
class Vpid final
{
    ...
    public:
        ...
        static auto alloc (cpu_t cpu)
        {
            return ++*Kmem::loc_to_glob (cpu, &allocator);
        }

        static void invalidate (Invvpid::Type t, uint16_t vpid, uint64_t addr = 0)
        {
