...
struct Descriptor_idt final : public Descriptor<4>
{
     ...
     * @param i Instruction Pointer (Interrupt Handler Entry)
     */
    explicit constexpr Descriptor_idt (Type t, unsigned d, uint16_t s, uint64_t i) : Descriptor { static_cast<uint32_t>(s << 16 | (i & BIT_RANGE (15, 0))),
                                                                                                  static_cast<uint32_t>((i & BIT_RANGE (31, 16)) | BIT (15) | d << 13 | std::to_underlying (t) << 8),
