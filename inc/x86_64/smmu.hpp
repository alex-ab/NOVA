...
class Smmu final : public List<Smmu>
{
    private:
        ...
        enum class Reg64 : unsigned
        {
            ...
            IQERCD      = 0x0b0,            // Invalidation Queue Error Record
        ...
        static inline constinit uintptr_t mmap  { MMAP_GLB_SMMU };
        ...
        bool feature (Cap  c) const { return cap  & BIT64 (std::to_underlying (c)); }
        bool feature (Ecap e) const { return ecap & BIT64 (std::to_underlying (e)); }
