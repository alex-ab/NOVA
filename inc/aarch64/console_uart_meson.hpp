...
class Console_uart_meson final : private Console_uart
{
    private:
        ...
        bool tx_busy() const override final { return read (Reg32::STAT) & BIT (25); }
        bool tx_full() const override final { return read (Reg32::STAT) & BIT (21); }
        void tx (uint8_t c) const override final { write (Reg32::WBUF, c); }
        ...
        bool init() const override final
        {
            ...
            write (Reg32::CTRL, BIT_RANGE (24, 22));
            write (Reg32::MISC, 0);
            write (Reg32::BAUD, BIT_RANGE (24, 23) | (clock / 3 / baudrate & BIT_RANGE (22, 0)));
            write (Reg32::CTRL, BIT (15) | BIT (12));

            return true;
        }

    protected:
        explicit Console_uart_meson (Hpt::OAddr m, unsigned c) : Console_uart { c } { setup (Regs { .mem = m }); }
};
