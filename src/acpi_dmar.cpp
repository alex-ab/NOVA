 ...
 * Copyright (C) 2013-2025 Alexander Boettcher, Genode Labs GmbH
 *
...
{
    for (uint64 hpa = base & ~PAGE_MASK; hpa < limit; hpa += PAGE_SIZE (0))
        Pd::kern.dpt.update (Pd::kern.quota, hpa, 0, hpa, Dpt::DPT_R | Dpt::DPT_W, Memattr::ram());
