...
Vmcs::Vmcs (mword esp, mword bmp, mword cr3, uint64 eptp) : rev (basic.revision)
{
    ...
    write (HOST_EFER, Msr::read (Msr::Reg64::IA32_EFER));
...
void Vmcs::init()
{
    if (!Cpu::feature (Cpu::FEAT_VMX) || (Msr::read (Msr::Reg64::IA32_FEATURE_CONTROL) & 0x5) != 0x5) {
        Hip::hip->clr_feature (Hip::FEAT_VMX);
        return;
    }

    fix_cr0_set = static_cast<mword>( Msr::read (Msr::Reg64::IA32_VMX_CR0_FIXED0));
    fix_cr0_clr = static_cast<mword>(~Msr::read (Msr::Reg64::IA32_VMX_CR0_FIXED1));
    fix_cr4_set = static_cast<mword>( Msr::read (Msr::Reg64::IA32_VMX_CR4_FIXED0));
    fix_cr4_clr = static_cast<mword>(~Msr::read (Msr::Reg64::IA32_VMX_CR4_FIXED1));

    fix_cr0_clr |= CR0_CD | CR0_NW;

    basic.val       = Msr::read (Msr::Reg64::IA32_VMX_BASIC);
    ctrl_exi.val    = Msr::read (basic.ctrl ? Msr::Reg64::IA32_VMX_TRUE_EXI : Msr::Reg64::IA32_VMX_CTRL_EXI_PRI);
    ctrl_ent.val    = Msr::read (basic.ctrl ? Msr::Reg64::IA32_VMX_TRUE_ENT : Msr::Reg64::IA32_VMX_CTRL_ENT);
    ctrl_pin.val    = Msr::read (basic.ctrl ? Msr::Reg64::IA32_VMX_TRUE_PIN : Msr::Reg64::IA32_VMX_CTRL_PIN);
    ctrl_cpu[0].val = Msr::read (basic.ctrl ? Msr::Reg64::IA32_VMX_TRUE_CPU : Msr::Reg64::IA32_VMX_CTRL_CPU_PRI);

    if (has_secondary())
        ctrl_cpu[1].val = Msr::read (Msr::Reg64::IA32_VMX_CTRL_CPU_SEC);
    if (has_ept() || has_vpid())
    ...
    trace (TRACE_VIRT, "VMCS:%#010lx REV:%#x EPT:%d URG:%d VNMI:%d VPID:%d", Kmem::ptr_to_phys (root), basic.revision, has_ept(), has_urg(), has_vnmi(), has_vpid());
}
