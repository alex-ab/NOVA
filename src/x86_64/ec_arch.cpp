...
void Ec_arch::set_vmm_regs_vmx (Ec *const self)
{
    ...
    r.r8  = Cpu::feature (Cpu::Feature::ARCH_CAPABILITIES) ? Msr::read (Msr::Reg64::IA32_ARCH_CAPABILITIES) : 0;
    r.r9  = Cpu::feature (Cpu::Feature::CORE_CAPABILITIES) ? Msr::read (Msr::Reg64::IA32_CORE_CAPABILITIES) : 0;
    r.r10 = Cpu::feature (Cpu::Feature::SRBDS_CTRL) || r.r8 & BIT (18) ? Msr::read (Msr::Reg64::IA32_MCU_OPT_CTRL) : 0;
