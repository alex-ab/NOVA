...
Smmu_v2::Smmu_v2 (Board::Smmu const &brd) : Smmu { brd.mmio, PAGE_SIZE (0) }, idr0 { read (GR0_Reg32::IDR0) }, idr1 { read (GR0_Reg32::IDR1) }, idr2 { read (GR0_Reg32::IDR2) }, page_size { idr1 & BIT (31) ? BIT (16) : BIT (12) }, board (brd)
{
 ...
 */
void Smmu_v2::tlb_invalidate (unsigned ctx, uint64_t ipa)
{
 ...
 */
void Smmu_v2::tlb_invalidate (Sdid vmid)
{
    // Post TLB maintenance operation
 ...
 */
void Smmu_v2::tlb_sync_ctx (unsigned ctx)
{
