    ...
    switch (midr >> 24 & BIT_RANGE (7, 0)) {
        ...
        case 0x41:
            ...
            switch (midr >> 4 & BIT_RANGE (11, 0)) {
                ...
                case 0xd8a: part = "Cortex-A530 (Nevis)";           break;
                case 0xd8b: part = "Cortex-A730 (Gelas)";           break;
                case 0xd8c: part = "Cortex-X930 (Travis)";          break;
                case 0xd8e: part = "Neoverse N3 (Hermes)";          break;
                case 0xd8f: part = "Cortex-A320 (Arcadia)";         break;
                case 0xd90: part = "Cortex (Alto)";                 break;
            }
            break;
